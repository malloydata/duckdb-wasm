...
if [ "${CURRENT_BRANCH}" = "${DEFAULT_BRANCH}" ]; then
    echo "[ RUN ] Install @malloydata/duckdb-wasm-app to ${PAGES_DIR}/"
    find ${PAGES_DIR} \
        -mindepth 1 \
        -maxdepth 1 \
        -type d \
    ...
    echo "[ RUN ] Install @malloydata/duckdb-wasm typedocs to ${TARGET_DIR}/docs"
    ...
    echo "[ RUN ] Install @malloydata/duckdb-wasm-app to ${TARGET_DIR}/"
    rm -rf ${TARGET_DIR}
