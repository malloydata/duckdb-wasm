...
import { DuckDBConnectionProvider, DuckDBPlatform, DuckDBProvider } from '@malloydata/react-duckdb';
...
import duckdb_wasm_eh from '@malloydata/duckdb-wasm/dist/duckdb-eh.wasm';
import duckdb_wasm_coi from '@malloydata/duckdb-wasm/dist/duckdb-coi.wasm';
...
const DUCKDB_BUNDLES: duckdb.DuckDBBundles = {
    ...
    coi: {
        ...
        mainWorker: new URL('@malloydata/duckdb-wasm/dist/duckdb-browser-coi.worker.js', import.meta.url).toString(),
        pthreadWorker: new URL(
            '@malloydata/duckdb-wasm/dist/duckdb-browser-coi.pthread.worker.js',
            import.meta.url,
        ).toString(),
    },
};
